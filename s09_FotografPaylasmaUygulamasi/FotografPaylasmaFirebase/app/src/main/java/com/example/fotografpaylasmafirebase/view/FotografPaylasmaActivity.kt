...
import kotlinx.android.synthetic.main.activity_fotograf_paylama.*
...
class FotografPaylasmaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fotograf_paylama)
        ...
        if (secilenGorsel != null) {
            ...
            gorselReference.putFile(secilenGorsel!!).addOnSuccessListener { task ->
                ...
                yuklenenGorselReference.downloadUrl.addOnSuccessListener { uri ->
                    ...
                    val kullaniciYorumu = yorum_text.text.toString()
